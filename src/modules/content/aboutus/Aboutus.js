    ...
    const display = () => {
        return(
            <div className="App-Content center flex-column flex-left max">
                <p className="center siteHeader">About Us</p>
                <div id="aboutUsContent" className="margin15 center grey max80 bubble flex-left flex-column">
                    <p className="">
                        We are a new team of web developers looking to help make your mark on the web! Contact us if you'd like to see your vision on the web! 
